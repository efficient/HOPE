...
namespace ope {
	...
	namespace blendtrietest {
		...
		static const std::string kEmailFilePath = "../../datasets/email_100.txt";
		static const int kEmailTestSize = 100;
		static std::vector<std::string> emails;

		static const std::string kBlendingResultPath = "../../datasets/blend_results.txt";
		...
		TEST_F (BlendTrieTest, emailTrie) {
			...
			std::cout << blend_freq_vec.size() <<std::endl;
			std::cout << blend_results.size() <<std::endl;

			for (auto it = blend_freq_vec.begin(); it != blend_freq_vec.end(); it++){
				std::cout << it->first << "\t" << it->second << std::endl;
			}
