...
CSV_X_FILE_PATH = "results/ART/point/lat_email_art.csv"
CSV_Y_FILE_PATH = "results/ART/point/mem_email_art.csv"
GRAPH_OUTPUT_PATH = "figures/ART/point/lat_mem_email_art_point.pdf"
...
ax.annotate(LABELS[2], (data_x[2] * 0.92, data_y[2] * 0.88), ha='center', va='center', size=16)
ax.annotate(LABELS[3], ((data_x[3] + data_x[4])/2, data_y[4] * 0.88), ha='center', va='center', size=16)
ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2, data_y[6] * 0.92), ha='center', va='center', size=16)
