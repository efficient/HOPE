...
ax.annotate(LABELS[1], (data_x[1] * 0.96, data_y[1] * 1.08), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.72, data_y[2]), ha='center', va='center', size=ANNOTATOR_SIZE)
