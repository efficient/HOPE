...
CSV_ART_INS_FILE_PATH = "results/ART/range/final_insertlat_email_art_range.csv"
GRAPH_OUTPUT_PATH = "figures/ART/range/lat_email_art.pdf"
...
ax2.set_ylim(0, 2.5)
ax2.yaxis.set_ticks([0, 0.5, 1, 1.5, 2, 2.5])
