...
CSV_X_FILE_PATH = "results/hot/point/final_lookuplat_url_hot.csv"
CSV_Y_FILE_PATH = "results/hot/point/final_mem_url_hot.csv"
GRAPH_OUTPUT_PATH = "figures/hot/point/lat_mem_url_hot.pdf"
...
ax.annotate(LABELS[0], (data_x[0] * 1.3, data_y[0] * 1.07), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[1], (data_x[1] * 1.7, data_y[1]), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.92, data_y[2] * 0.9), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[3], (data_x[3] * 0.98, data_y[3] * 0.9), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[4], (data_x[4] * 1.26, data_y[4]), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[5], (data_x[5], data_y[5] * 0.9), ha='center', va='center', size=ANNOTATOR_SIZE)
