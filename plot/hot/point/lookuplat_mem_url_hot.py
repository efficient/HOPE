...
GRAPH_OUTPUT_PATH = "figures/hot/point/lat_mem_url_art_hot.pdf"
...
ax.annotate(LABELS[0], (data_x[0] * 1.12, data_y[0] * 1.08), ha='center', va='center', size=12)
ax.annotate(LABELS[1], (data_x[1] * 1.6, data_y[1]), ha='center', va='center', size=12)
