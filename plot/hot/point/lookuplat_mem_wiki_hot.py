...
ax.annotate(LABELS[1], (data_x[1] * 0.88, data_y[1] * 1.06), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.9, data_y[2] * 0.92), ha='center', va='center', size=ANNOTATOR_SIZE)
...
ax.annotate(LABELS[5], (data_x[5] * 1.02, data_y[5] * 0.9), ha='center', va='center', size=ANNOTATOR_SIZE)
