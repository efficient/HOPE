...
CSV_X_FILE_PATH = "results/hot/point/final_lookuplat_email_hot.csv"
CSV_Y_FILE_PATH = "results/hot/point/final_mem_email_hot.csv"
GRAPH_OUTPUT_PATH = "figures/hot/point/lat_mem_email_hot.pdf"
...
ax.annotate(LABELS[1], (data_x[1] * 0.82, data_y[1] * 1.05), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.8, data_y[2] * 0.92), ha='center', va='center', size=ANNOTATOR_SIZE)
...
ax.annotate(LABELS[5], (data_x[5] * 1.04, data_y[5] * 0.88), ha='center', va='center', size=ANNOTATOR_SIZE)
