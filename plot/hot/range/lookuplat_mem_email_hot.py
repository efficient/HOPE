...
CSV_X_FILE_PATH = "results/hot/range/final_lookuplat_email_hot_range.csv"
CSV_Y_FILE_PATH = "results/hot/range/final_mem_email_hot_range.csv"
GRAPH_OUTPUT_PATH = "figures/hot/range/lookuplat_mem_email_hot_range.pdf"
