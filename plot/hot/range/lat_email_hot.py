...
CSV_HOT_LOOKUP_FILE_PATH = "results/hot/range/final_lookuplat_email_hot_range.csv"
CSV_HOT_INS_FILE_PATH = "results/hot/range/final_insertlat_email_hot_range.csv"
