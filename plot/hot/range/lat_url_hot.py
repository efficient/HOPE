...
CSV_HOT_LOOKUP_FILE_PATH = "results/hot/range/final_lookuplat_url_hot_range.csv"
CSV_HOT_INS_FILE_PATH = "results/hot/range/final_insertlat_url_hot_range.csv"
GRAPH_OUTPUT_PATH = "figures/hot/range/lat_url_hot.pdf"
