...
CSV_Y_DC_FILE_PATH = "results/microbench/ht_vs_dc/lat_email_dc.csv"
CSV_Y_HT_FILE_PATH = "results/microbench/ht_vs_dc/lat_email_ht.csv"
GRAPH_OUTPUT_PATH = "figures/microbench/ht_vs_dc/lat_email_ht_vs_dc.pdf"
