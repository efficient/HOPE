...
CSV_Y_FILE_PATH = "results/microbench/cpr_latency/final_cpr_url_dict_size.csv"
GRAPH_OUTPUT_PATH = "figures/microbench/cpr_latency/cpr_url_dict_size.pdf"
...
ax.plot(alm_improved_x, alm_improved_y, marker=MARKERS[5], ms=10, lw = 3, mew = BORDER_SIZE, mec = BORDER_COLOR,  color = COLORS[5], label=LINE_NAMES[5])
