...
CSV_X_FILE_PATH = "results/microbench/cpr_latency/x_ts_dict_size.csv"
CSV_Y_FILE_PATH = "results/microbench/cpr_latency/cpr_ts_dict_size.csv"
GRAPH_OUTPUT_PATH = "figures/microbench/cpr_latency/cpr_ts_dict_size.pdf"
...
for i in range(2, 2 + NUM_3_POINTS * 2, 2) :
    three_grams_x.append(data_x[i])
    three_grams_y.append(data_y[i])
    four_grams_x.append(data_x[i+1])
    four_grams_y.append(data_y[i+1])
...
for i in range(2 + NUM_3_POINTS * 2, 2 + NUM_3_POINTS * 2 + NUM_4_EXTRA_POINTS, 1) :
    four_grams_x.append(data_x[i])
    four_grams_y.append(data_y[i])
#    alm_x.append(data_x[i+1])
#    alm_y.append(data_y[i+1])
