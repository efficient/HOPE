...
CSV_X_FILE_PATH = "results/microbench/cpr_latency/x_url_dict_size.csv"
CSV_Y_FILE_PATH = "results/microbench/cpr_latency/mem_url_dict_size.csv"
GRAPH_OUTPUT_PATH = "figures/microbench/cpr_latency/mem_url_dict_size.pdf"
...
for i in range(2 + NUM_3_POINTS * 3, 2 + NUM_3_POINTS * 3 + NUM_4_EXTRA_POINTS * 2, 2) :
