...
CSV_FILE_PATH = "results/microbench/sample_size_sweep/bt_url_sample_size_sweep.csv"
GRAPH_OUTPUT_PATH = "figures/microbench/sample_size_sweep/bt_url_sample_size_sweep.pdf"
