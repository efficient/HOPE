...
GRAPH_OUTPUT_PATH = "figures/microbench/build_time_breakdown/bt_100_breakdown.pdf"
...
#ax.pie(sizes_100, explode=EXPLODE, labels=LABELS, colors=COLORS,
#       autopct='%1.1f\%%', shadow=True, startangle=90)

ax.pie(sizes_100, explode=EXPLODE, colors=COLORS, startangle=90)
