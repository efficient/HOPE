...
CSV_X_FILE_PATH = "results/SuRF_real/range/lat_wiki_surfreal_range.csv"
CSV_Y_FILE_PATH = "results/SuRF_real/range/mem_wiki_surfreal_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF_real/range/lat_mem_wiki_surfreal_range.pdf"
...
ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2, data_y[6] * 0.88), ha='center', va='center', size=16)
