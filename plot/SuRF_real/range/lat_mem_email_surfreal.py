...
CSV_X_FILE_PATH = "results/SuRF_real/range/lat_email_surfreal_range.csv"
CSV_Y_FILE_PATH = "results/SuRF_real/range/mem_email_surfreal_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF_real/range/lat_mem_email_surfreal_range.pdf"
...
ax.annotate(LABELS[2], (data_x[2], data_y[2] * 0.88), ha='center', va='center', size=16)
ax.annotate(LABELS[3], ((data_x[3] + data_x[4])/2, data_y[4] * 0.88), ha='center', va='center', size=16)
ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2 * 1.15, data_y[6]), ha='center', va='center', size=16)
