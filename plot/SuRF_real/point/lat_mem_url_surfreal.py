...
CSV_X_FILE_PATH = "results/SuRF_real/point/lat_url_surfreal.csv"
CSV_Y_FILE_PATH = "results/SuRF_real/point/mem_url_surfreal.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF_real/point/lat_mem_url_surfreal_point.pdf"
