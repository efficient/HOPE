...
CSV_X_FILE_PATH = "results/SuRF_real/point/lat_wiki_surfreal.csv"
CSV_Y_FILE_PATH = "results/SuRF_real/point/mem_wiki_surfreal.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF_real/point/lat_mem_wiki_surfreal_point.pdf"
...
ax.annotate(LABELS[1], (data_x[1], data_y[1] * 1.12), ha='center', va='center', size=16)
ax.annotate(LABELS[2], (data_x[2], data_y[2] * 0.86), ha='center', va='center', size=16)
ax.annotate(LABELS[3], ((data_x[3] + data_x[4])/2, data_y[4] * 0.85), ha='center', va='center', size=16)
ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2 * 1.05, data_y[6] * 0.85), ha='center', va='center', size=16)
