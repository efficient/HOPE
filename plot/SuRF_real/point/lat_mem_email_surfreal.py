...
CSV_X_FILE_PATH = "results/SuRF_real/point/lat_email_surfreal.csv"
CSV_Y_FILE_PATH = "results/SuRF_real/point/mem_email_surfreal.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF_real/point/lat_mem_email_surfreal_point.pdf"
...
ax.annotate(LABELS[1], (data_x[1] * 1.12, data_y[1] * 0.98), ha='center', va='center', size=16)
...
ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2 * 1.18, data_y[6]), ha='center', va='center', size=16)
