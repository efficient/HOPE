...
CSV_X_FILE_PATH = "results/ART_single/point/lookuplat_wiki_art.csv"
CSV_Y_FILE_PATH = "results/ART_single/point/mem_wiki_art.csv"
GRAPH_OUTPUT_PATH = "figures/ART_single/point/lookuplat_mem_wiki_art_point.pdf"
...
#ax.annotate(LABELS[1], (data_x[1] * 0.88, data_y[1] * 1.08), ha='center', va='center', size=12)
#ax.annotate(LABELS[2], (data_x[2] * 0.88, data_y[2] * 0.9), ha='center', va='center', size=12)
#ax.annotate(LABELS[3], ((data_x[3] + data_x[4])/2, data_y[4] * 0.88), ha='center', va='center', size=12)
#ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2 * 1.05, data_y[6] * 0.92), ha='center', va='center', size=12)
