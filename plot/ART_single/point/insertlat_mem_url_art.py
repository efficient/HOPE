...
CSV_X_FILE_PATH = "results/ART_single/point/insertlat_url_art.csv"
CSV_Y_FILE_PATH = "results/ART_single/point/mem_url_art.csv"
GRAPH_OUTPUT_PATH = "figures/ART_single/point/insertlat_mem_url_art_point.pdf"
