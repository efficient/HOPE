...
CSV_X_FILE_PATH = "results/ART/point/insertlat_ts_art.csv"
CSV_Y_FILE_PATH = "results/ART/point/mem_ts_art.csv"
GRAPH_OUTPUT_PATH = "figures/ART/point/insertlat_mem_ts_art_point.pdf"
