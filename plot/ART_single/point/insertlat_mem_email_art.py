...
CSV_X_FILE_PATH = "results/ART_single/point/insertlat_email_art.csv"
CSV_Y_FILE_PATH = "results/ART_single/point/mem_email_art.csv"
GRAPH_OUTPUT_PATH = "figures/ART_single/point/insertlat_mem_email_art_point.pdf"
...
ax.scatter(data_x[0], data_y[0], s=SIZE, c=COLORS[0], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[0])
ax.scatter(data_x[1], data_y[1], s=SIZE, c=COLORS[1], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[1])
ax.scatter(data_x[2], data_y[2], s=SIZE, c=COLORS[2], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[2])
ax.scatter(data_x[3], data_y[3], s=SIZE, c=COLORS[3], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[3])
ax.scatter(data_x[4], data_y[4], s=SIZE, c=COLORS[3], marker='s', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[4])
ax.scatter(data_x[5], data_y[5], s=SIZE, c=COLORS[4], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[5])
ax.scatter(data_x[6], data_y[6], s=SIZE, c=COLORS[4], marker='s', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[6])
#ax.scatter(data_x[7], data_y[7], s=SIZE, c=COLORS[5], marker='o', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[7])
#ax.scatter(data_x[8], data_y[8], s=SIZE, c=COLORS[5], marker='s', edgecolors = EDGE_COLOR, linewidths = SHAPE_BORDER, label=NAMES[8])
