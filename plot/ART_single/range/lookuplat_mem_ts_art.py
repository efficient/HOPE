...
NAMES = ["Uncompressed", "Single", "Double", "3-Grams, 8192", "3-Grams, 65536", "4-Grams, 8192", "4-Grams, 65536", "ALM, 10000", "ALM, 65535"]
...
CSV_X_FILE_PATH = "results/ART/range/lookuplat_ts_art_range.csv"
CSV_Y_FILE_PATH = "results/ART/range/mem_ts_art_range.csv"
GRAPH_OUTPUT_PATH = "figures/ART/range/lookuplat_mem_ts_art_range.pdf"
...
#ax.annotate(LABELS[1], (data_x[1] * 0.9, data_y[1] * 1.06), ha='center', va='center', size=12)
#ax.annotate(LABELS[2], (data_x[2] * 0.9, data_y[2] * 0.92), ha='center', va='center', size=12)
#ax.annotate(LABELS[3], (data_x[3] * 1.1, data_y[4] * 0.88), ha='center', va='center', size=12)
#ax.annotate(LABELS[4], (data_x[5] * 1.1, data_y[6] * 0.92), ha='center', va='center', size=12)
#ax.annotate(LABELS[5], ((data_x[7] + data_x[8])/2, data_y[7] * 0.92), ha='center', va='center', size=12)
