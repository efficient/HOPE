...
CSV_X_FILE_PATH = "results/prefixbtree/point/final_lookuplat_email_btree.csv"
CSV_Y_FILE_PATH = "results/prefixbtree/point/final_mem_email_btree.csv"
GRAPH_OUTPUT_PATH = "figures/prefixbtree/point/lat_mem_email_btree_point.pdf"
...
#ax.annotate(LABELS[1], (data_x[1] * 0.94, data_y[1] * 1.08), ha='center', va='center', size=12)
#ax.annotate(LABELS[2], (data_x[2] * 0.82, data_y[2]), ha='center', va='center', size=12)
#ax.annotate(LABELS[3], (data_x[3] * 0.92, data_y[3] * 0.9), ha='center', va='center', size=12)
#ax.annotate(LABELS[4], (data_x[4] * 1.1, data_y[4] * 0.9), ha='center', va='center', size=12)
#ax.annotate(LABELS[5], (data_x[5] * 1.07, data_y[5] * 1.07), ha='center', va='center', size=12)
#ax.annotate(LABELS[6], (data_x[6] * 1.07, data_y[6] * 0.9), ha='center', va='center', size=12)
