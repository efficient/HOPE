...
LABELS = ["Uncompressed", "Single", "Double", "3-Grams", "4-Grams", "ALM-Improved (4K)", "ALM-Improve (64K)"]
...
CSV_X_FILE_PATH = "results/prefixbtree/point/final_lookuplat_url_btree.csv"
CSV_Y_FILE_PATH = "results/prefixbtree/point/final_mem_url_btree.csv"
GRAPH_OUTPUT_PATH = "figures/prefixbtree/point/lat_mem_url_btree_point.pdf"
...
ax.scatter(data_x[0], data_y[0], s=SIZE, c=COLORS[0], marker='o', linewidths = BORDER_SIZE, edgecolors = EDGE_COLOR, label=NAMES[0], hatch=HATCH*10)
...
#ax.annotate(LABELS[1], (data_x[1] * 0.92, data_y[1] * 1.08), ha='center', va='center', size=12)
#ax.annotate(LABELS[2], (data_x[2] * 0.6, data_y[2]), ha='center', va='center', size=12)
