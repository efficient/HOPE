...
CSV_ART_LOOKUP_FILE_PATH = "results/prefixbtree/range/final_lookuplat_wiki_btree_range.csv"
CSV_ART_INS_FILE_PATH = "results/prefixbtree/range/final_insertlat_wiki_btree_range.csv"
GRAPH_OUTPUT_PATH = "figures/prefixbtree/range/lat_wiki_btree.pdf"
