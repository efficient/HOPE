...
CSV_X_FILE_PATH = "results/btree/range/lookuplat_wiki_btree_range.csv"
CSV_Y_FILE_PATH = "results/btree/range/mem_wiki_btree_range.csv"
GRAPH_OUTPUT_PATH = "figures/btree/range/lookuplat_mem_wiki_btree_range.pdf"
