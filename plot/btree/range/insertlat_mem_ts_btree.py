...
CSV_X_FILE_PATH = "results/btree/range/insertlat_ts_btree_range.csv"
CSV_Y_FILE_PATH = "results/btree/range/mem_ts_btree_range.csv"
GRAPH_OUTPUT_PATH = "figures/btree/range/insertlat_mem_ts_btree_range.pdf"
