...
CSV_ART_LOOKUP_FILE_PATH = "results/btree/range/final_lookuplat_email_btree_range.csv"
CSV_ART_INS_FILE_PATH = "results/btree/range/final_insertlat_email_btree_range.csv"
GRAPH_OUTPUT_PATH = "figures/btree/range/lat_email_btree.pdf"
