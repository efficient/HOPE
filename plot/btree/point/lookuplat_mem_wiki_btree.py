...
CSV_X_FILE_PATH = "results/btree/point/lookuplat_wiki_btree.csv"
CSV_Y_FILE_PATH = "results/btree/point/mem_wiki_btree.csv"
GRAPH_OUTPUT_PATH = "figures/btree/point/lookuplat_mem_wiki_btree_point.pdf"
