...
CSV_X_FILE_PATH = "results/btree/point/lookuplat_ts_btree.csv"
CSV_Y_FILE_PATH = "results/btree/point/mem_ts_btree.csv"
GRAPH_OUTPUT_PATH = "figures/btree/point/lookuplat_mem_ts_btree_point.pdf"
