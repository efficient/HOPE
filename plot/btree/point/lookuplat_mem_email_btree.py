...
CSV_X_FILE_PATH = "results/btree/point/lookuplat_email_btree.csv"
CSV_Y_FILE_PATH = "results/btree/point/mem_email_btree.csv"
GRAPH_OUTPUT_PATH = "figures/btree/point/lookuplat_mem_email_btree_point.pdf"
