...
ax.scatter(data_x[0], data_y[0], s=SIZE, c=COLORS[0], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[0], hatch='///////')
ax.scatter(data_x[1], data_y[1], s=SIZE, c=COLORS[1], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[1])
ax.scatter(data_x[2], data_y[2], s=SIZE, c=COLORS[2], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[2])
ax.scatter(data_x[3], data_y[3], s=SIZE, c=COLORS[3], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[3])
ax.scatter(data_x[4], data_y[4], s=SIZE, c=COLORS[4], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[4])
ax.scatter(data_x[5], data_y[5], s=SIZE, c=COLORS[5], marker='o', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[5])
ax.scatter(data_x[6], data_y[6], s=SIZE, c=COLORS[6], marker='s', linewidths = SHAPE_BORDER, edgecolors = BORDER_COLOR, label=NAMES[6])
...
x_ticks = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5]
...
ax.annotate(LABELS[1], (data_x[1] * 0.94, data_y[1] * 1.06), ha='center', va='center', size=12)
...
ax.annotate(LABELS[5], (data_x[6] * 1.1, data_y[6] * 1.06), ha='center', va='center', size=12)
