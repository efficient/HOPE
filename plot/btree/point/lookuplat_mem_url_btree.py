...
ax.scatter(data_x[0], data_y[0], s=MARKER_SIZE, c=COLORS[0], marker=MARKERS[0], linewidths = BORDER_SIZE, edgecolors = EDGE_COLOR, label=NAMES[0], hatch=HATCH*2)
ax.scatter(data_x[1], data_y[1], s=MARKER_SIZE, c=COLORS[1], marker=MARKERS[1], linewidths = BORDER_SIZE, edgecolors = EDGE_COLOR, label=NAMES[1])
ax.scatter(data_x[2], data_y[2], s=MARKER_SIZE, c=COLORS[2], marker=MARKERS[2], linewidths = BORDER_SIZE, edgecolors = EDGE_COLOR, label=NAMES[2])
...
ax.annotate(LABELS[1], (data_x[1] * 0.92, data_y[1] * 1.08), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.6, data_y[2]), ha='center', va='center', size=ANNOTATOR_SIZE)
