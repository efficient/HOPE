...
CSV_X_FILE_PATH = "results/btree/point/insertlat_url_btree.csv"
CSV_Y_FILE_PATH = "results/btree/point/mem_url_btree.csv"
GRAPH_OUTPUT_PATH = "figures/btree/point/insertlat_mem_url_btree_point.pdf"
