...
CSV_X_FILE_PATH = "results/SuRF/point/final_lat_email_surf.csv"
CSV_Y_FILE_PATH = "results/SuRF/point/final_mem_email_surf.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/point/lat_mem_email_surf_point.pdf"
...
ax.annotate(LABELS[1], (data_x[1] * 1.18, data_y[1]), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[2], (data_x[2] * 0.78, data_y[2]), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[3], (data_x[3], data_y[3] * 0.90), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[4], (data_x[4], data_y[4] * 1.08), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[5], (data_x[5] * 1.1 , data_y[5] * 0.90), ha='center', va='center', size=ANNOTATOR_SIZE)
ax.annotate(LABELS[6], (data_x[6], data_y[6] * 1.06), ha='center', va='center', size=ANNOTATOR_SIZE)
