...
CSV_X_FILE_PATH = "results/SuRF/point/lat_ts_surf.csv"
CSV_Y_FILE_PATH = "results/SuRF/point/mem_ts_surf.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/point/lat_mem_ts_surf_point.pdf"
