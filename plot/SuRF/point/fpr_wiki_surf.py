...
CSV_SURF_FPR_FILE_PATH = "results/SuRF/point/final_fpr_wiki_surf.csv"
CSV_SURF_HEI_FILE_PATH = "results/SuRF/point/final_height_wiki_surf.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/point/fpr_wiki_surf_point.pdf"
