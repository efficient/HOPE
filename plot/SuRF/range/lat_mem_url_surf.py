...
CSV_X_FILE_PATH = "results/SuRF/range/final_lat_url_surf_range.csv"
CSV_Y_FILE_PATH = "results/SuRF/range/final_mem_url_surf_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/range/lat_mem_url_surf_range.pdf"
...
ax.scatter(data_x[0], data_y[0], s=SIZE, c=COLORS[0], marker='o', linewidths=BORDER_SIZE, edgecolors=EDGE_COLOR, label=NAMES[0], hatch="///////")
ax.scatter(data_x[1], data_y[1], s=SIZE, c=COLORS[1], marker='o', linewidths=BORDER_SIZE, edgecolors=EDGE_COLOR, label=NAMES[1])
ax.scatter(data_x[2], data_y[2], s=SIZE, c=COLORS[2], marker='o', linewidths=BORDER_SIZE, edgecolors=EDGE_COLOR, label=NAMES[2])
...
ax.scatter(data_x[6], data_y[6], s=SIZE, c=COLORS[5], marker='s', linewidths=BORDER_SIZE, edgecolors=EDGE_COLOR, label=NAMES[6])
...
ax.annotate(LABELS[0], (data_x[0], data_y[0] * 1.06), ha='center', va='center', size=12)
...
ax.annotate(LABELS[3], (data_x[3] * 1.1, data_y[3] * 0.9), ha='center', va='center', size=12)
ax.annotate(LABELS[4], (data_x[4] * 1.14, data_y[4] * 0.94), ha='center', va='center', size=12)
ax.annotate(LABELS[5], (data_x[5], data_y[5] * 1.06), ha='center', va='center', size=12)
ax.annotate(LABELS[5], (data_x[6], data_y[6] * 1.05), ha='center', va='center', size=12)
