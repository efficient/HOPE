...
CSV_ART_LOOKUP_FILE_PATH = "results/SuRF/range/final_lat_wiki_surf_range.csv"
CSV_ART_INS_FILE_PATH = "results/SuRF/range/final_stats_wiki_surf_range.csv"
#CSV_ART_INS_FILE_PATH = "results/SuRF/point/final_stats_wiki_surf.csv"
...
y1_ticks = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4]
