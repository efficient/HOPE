...
CSV_X_FILE_PATH = "results/SuRF/range/lat_ts_surf_range.csv"
CSV_Y_FILE_PATH = "results/SuRF/range/mem_ts_surf_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/range/lat_mem_ts_surf_range.pdf"
