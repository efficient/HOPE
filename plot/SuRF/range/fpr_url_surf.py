...
CSV_SURF_FILE_PATH = "results/SuRF/range/fpr_url_surf_range.csv"
CSV_SURFREAL_FILE_PATH = "results/SuRF_real/range/fpr_url_surfreal_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/range/fpr_url_surf_range.pdf"
