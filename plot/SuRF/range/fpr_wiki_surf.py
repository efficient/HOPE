...
CSV_SURF_FILE_PATH = "results/SuRF/range/fpr_wiki_surf_range.csv"
CSV_SURFREAL_FILE_PATH = "results/SuRF_real/range/fpr_wiki_surfreal_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/range/fpr_wiki_surf_range.pdf"
