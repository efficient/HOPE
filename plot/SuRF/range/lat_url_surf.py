...
#CSV_ART_LOOKUP_FILE_PATH = "results/SuRF/range/final_lat_url_surf_range.csv"
CSV_ART_INS_FILE_PATH = "results/SuRF/range/final_stats_url_surf_range.csv"
CSV_ART_INS_FILE_PATH = "results/SuRF/point/final_stats_url_surf.csv"
...
y1_ticks = [0, 5, 10, 15, 20, 25, 30]
ax1.set_yticks(y1_ticks)
ax1.set_ylim(0, 30)

ax2.set_ylabel(Y_LABELS[1], fontsize=Y_LABEL_FONT_SIZE)
ax2.set_ylim(0, 180)
ax2.yaxis.set_ticks([0, 30, 60, 90, 120, 150, 180])
