...
CSV_ART_LOOKUP_FILE_PATH = "results/SuRF/range/final_stats_url_SuRF_range.csv"
CSV_ART_INS_FILE_PATH = "results/SuRF/range/final_insertlat_url_SuRF_range.csv"
GRAPH_OUTPUT_PATH = "figures/ART/range/lat_url_SuRF.pdf"
