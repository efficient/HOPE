...
CSV_X_FILE_PATH = "results/SuRF/range/final_lat_email_surf_range.csv"
CSV_Y_FILE_PATH = "results/SuRF/range/final_mem_email_surf_range.csv"
...
ax.annotate(LABELS[4], (data_x[4] * 1.12, data_y[4] * 0.94), ha='center', va='center', size=12)
ax.annotate(LABELS[5], (data_x[5] * 0.98, data_y[5] * 0.9), ha='center', va='center', size=12)
