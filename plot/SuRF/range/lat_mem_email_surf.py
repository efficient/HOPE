...
CSV_X_FILE_PATH = "results/SuRF/range/lat_email_surf_range.csv"
CSV_Y_FILE_PATH = "results/SuRF/range/mem_email_surf_range.csv"
GRAPH_OUTPUT_PATH = "figures/SuRF/range/lat_mem_email_surf_range.pdf"
...
x_ticks = [0, 0.5, 1, 1.5, 2.0, 2.5, 3.0]
...
#ax.annotate(LABELS[4], ((data_x[5] + data_x[6])/2 * 1.1, data_y[6] * 0.92), ha='center', va='center', size=12)
#ax.annotate(LABELS[5], ((data_x[7] + data_x[8])/2, data_y[7]), ha='center', va='center', size=12)
