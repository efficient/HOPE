...
Code Array4GramDict::lookup(const char *symbol, const int symbol_len, int &prefix_len) const {
...
int Array4GramDict::compareDictEntry(const char *s1, const int s1_len, const int dict_idx) const {
