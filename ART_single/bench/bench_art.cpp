...
// Expt ID = 0
//-------------------------------------------------------------
static const std::string output_dir_art_point = "results/ART_single/point/";
...
// Expt ID = 1
//-------------------------------------------------------------
static const std::string output_dir_art_range = "results/ART_single/range/";
...
void exec(const int expt_id, const int wkld_id, const bool is_point,
	...
	art->insert(key, (TID)&(enc_insert_keys[i]));
    }
